...
let myPlaces:string[]=["AMERICA","LONDON","ITALY","NEWZELAND","TURKEY"]
console.log(myPlaces);

// // copy of array:
let copy_of_array = myPlaces.slice();

// alphabetic Array:
let alphabetic_array = copy_of_array.sort();
...
let reversedarray = copy_of_array.reverse()
